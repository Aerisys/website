...
<template>
  <div class="group bg-white rounded-2xl overflow-hidden shadow-sm border border-gray-100 hover:shadow-lg transition-all duration-300">
    <!-- Image placeholder -->
    ...
    <div class="p-4 text-center">
      ...
      <button class="mt-3 px-4 py-1.5 text-xs font-medium text-primary-600 border border-primary-200 rounded-full hover:bg-primary-50 transition-colors">
        Services
      </button>
    </div>
  </div>
