<template>
    <div :class="cn('group h-80 w-72 [perspective:1000px] cursor-pointer', props.class)">
        ...
        >
            ...
            >
                <slot>
                    <div class="bg-white rounded-2xl p-8 shadow-sm border border-gray-100 hover:shadow-lg hover:border-gray-200 transition-all duration-300 h-full flex flex-col items-center justify-center gap-5">
                        <!-- Icon -->
                        <div class="w-20 h-20 bg-gray-50 rounded-2xl flex items-center justify-center">
                            <img :src="`/icons/${props.icon}.svg`" alt="" class="w-10 h-10 object-contain" />
                        </div>
                        ...
                        <div class="w-10 h-10 rounded-full bg-gray-100 group-hover:bg-primary-500 text-gray-400 group-hover:text-white flex items-center justify-center transition-all duration-300">
            ...
            >
                <slot name="back">
                    <div class="bg-white rounded-2xl p-6 shadow-sm border border-gray-100 hover:shadow-lg hover:border-gray-200 transition-all duration-300 h-full flex flex-col">
                        <!-- Icon en haut -->
                        ...
                        <div class="mt-3 flex items-center justify-center">
                            <h3 class="text-base font-display font-bold text-gray-900 text-center">{{ props.title }}</h3>
                        </div>

                        <!-- Texte centré verticalement et justifié -->
                        <div class="flex-1 flex items-center">
                            <p class="text-gray-600 text-sm leading-relaxed text-justify px-2">{{ props.description }}</p>
                        </div>
                    </div>
                </slot>
            </div>
